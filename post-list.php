						...
						<div class="col-xl-12">
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div><a href="add-post.php"class="btn btn-success">Add Post</a></div><br>
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">All Post List</h4>
										<i class="mdi mdi-dots-horizontal text-gray"></i>
									</div>

									<p class="tx-12 tx-gray-500 mb-2 text-primary"> <?php
if (isset($_GET['msg'])) {
        echo $_GET['msg'];
    }
    ?></p>
										...
										<table id="example" class="table key-buttons text-md-nowrap">
											<thead>
												<tr>
													...
													<th class="border-bottom-0" >Post Status</th>
    ...
    $query = "SELECT posts.*, category.name as 'category_name' FROM posts
	JOIN category
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        ?>
												<tr>
													...
													<td class="border-bottom-0"><?php echo $row['title']; ?></td>
